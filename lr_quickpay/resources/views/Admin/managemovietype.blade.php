                 ...
                 <section class="content">
                    <div class="row">	
                         ...
                         <div class="col-sm-6">         
                            <div class="box box-solid" >
                                <div class="box-header" style="height: 60px;background:#f8f8f8">
                                    <h4 style="color:black;">Edit Movie Type</h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-xm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            {!! Form::text('movie',$data['movie']->name,array('placeholder'=>"Enter Movie Type" , 'class'=>'form-control', 'required'=>'' , 'pattern'=>'^[a-zA-Z ]+$'))  !!}
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <a href="{!! url('Movie-Type') !!}" class="btn btn-send" style="background: #e2e6ea;color:black;" ><i class="fa fa-times"></i>&nbsp;Cancel</a>
                       ...
                       <div class="col-sm-6">         
                            <div class="box box-solid" >
                                <div class="box-header" style="height: 60px;background:#f8f8f8">
                                    <h4 style="color:black;">Add New Movie Type</h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-xm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            {!! Form::text('movie','',array('placeholder'=>"Enter Movie Type" , 'class'=>'form-control', 'required'=>'' , 'pattern'=>'^[a-zA-Z ]+$'))  !!}
                                            ...
                                            <div class="table-responsive">
                                                <table id="example5" class="table table-bordered table-striped" style="width:100%;text-align: center;">
                                                    <thead>
                                                        <tr>
                                                            <th>No</th>
                                                            <th style="padding: 15px 5px 5px 19px;text-align: center" align="center">Movie Type</th>
                                                            <th>Edit</th>
                                                            <th>Remove</th>
                                                    ...
                                                    <tbody>
                                                       ...
                                                       <?php
                                                        $movie=DB::table('tbl_movie_type')->where("label","=","main")->get();
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="{!!url('Edit-Movie-Data/'.$val->type_id) !!}"><i class="fas fa-pencil-alt" style="font-size:14px; color: #0071cc"></i></a></td>
                                                            <td><a href="{!!url('Remove/movie/'.$val->type_id) !!}"><i class="fa fa-trash" style="font-size:14px; color: #0071cc"></i></a></td>
